...
MODEL_PATH="${REPO_ROOT}/onboard/models/parallel-walking-v24-padded-feet-forward-bias/model_3248.onnx"
MODEL_METADATA="${REPO_ROOT}/onboard/models/parallel-walking-v24-padded-feet-forward-bias/model_3248.json"
...
if head -n 1 "${MODEL_PATH}" | grep -q '^version https://git-lfs'; then
  ...
  git -C "${REPO_ROOT}" lfs pull \
    --include="onboard/models/parallel-walking-v24-padded-feet-forward-bias/model_3248.onnx"
fi
