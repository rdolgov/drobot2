...
from drobot_cad.interfaces import (
    ST3215_MOTOR_BAY_INTERFACES,
    ST3215_SERVO_OUTPUT_FORK_INTERFACES,
    UPPER_ARM_INTERFACES,
)
from drobot_cad.parts import st3215_servo_output_fork
from drobot_cad.parts.st3215_motor_bay import st3215_installed_location
from drobot_cad.parts.upper_arm import (
    distal_fork_axis_location,
    st3215_output_axis_location,
    st3215_preview_location,
)
from drobot_cad.validation import validate_interface_frame
