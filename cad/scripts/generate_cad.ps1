...
$targets = @(
    "drobot_cad/parts/st3215_motor_bay.py=exports/step/st3215_motor_bay.step",
    "drobot_cad/parts/st3215_servo_visual.py=exports/step/st3215_servo_visual.step",
    "drobot_cad/parts/upper_arm.py=exports/step/upper_arm.step",
    "drobot_cad/parts/st3215_servo_output_fork.py=exports/step/st3215_servo_output_fork.step",
    "drobot_cad/parts/st3215_hip.py=exports/step/st3215_hip.step",
    "drobot_cad/parts/st3215_hip_body_mount.py=exports/step/st3215_hip_body_mount.step",
    "drobot_cad/parts/quadruped_body.py=exports/step/quadruped_body_base.step",
    "drobot_cad/parts/quadruped_body_lid.py=exports/step/quadruped_body_lid.step",
    "drobot_cad/parts/quadruped_electronics_tray.py=exports/step/quadruped_electronics_tray.step",
    "drobot_cad/parts/quadruped_imu_cover.py=exports/step/quadruped_imu_cover.step",
    "drobot_cad/parts/lekiwi_12v_battery_reference.py=exports/step/lekiwi_12v_battery_reference.step",
    "drobot_cad/parts/waveshare_bus_servo_adapter_a.py=exports/step/waveshare_bus_servo_adapter_a.step",
    "drobot_cad/parts/adafruit_bno085.py=exports/step/adafruit_bno085_stemma_qt.step",
    "drobot_cad/assembly/hip_orientation_preview.py=exports/step/hip_orientation_preview.step",
    "drobot_cad/assembly/st3215_motor_bay_fit_preview.py=exports/step/st3215_motor_bay_fit_preview.step",
