param(
    ...
    [string]$OutputDir = 'simulation/isaac/output/rl/ppo-stairs-v44-early-contact-rear-right-landing-512-seed869',
    [int]$Seed = 869
)
...
try {
    ...
    if ($LASTEXITCODE -ne 0) {
        throw "V44 early-contact landing PPO failed with exit code $LASTEXITCODE"
    }
}
finally {
    Pop-Location
