...
from drobot_cad.urdf import one_leg_wall_testbed as model  # noqa: E402
...
parser.add_argument(
    "--usd",
    default="simulation/exports/isaac/one_leg_wall_testbed.usdc",
)
parser.add_argument(
    "--hardware-config",
    default="hardware/robot-runtime/servos/leg-1.toml",
)
parser.add_argument(
    "--calibration",
    default="hardware/robot-runtime/servos/calibration-leg-1.json",
)
parser.add_argument(
    "--report",
