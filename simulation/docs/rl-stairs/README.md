...
Run every command from the repository root. Scripts importing Isaac Sim
...
| World | `simulation/exports/isaac/quadruped_robot_stairs_world.usda` |
...
| --- | --- |
| [`__init__.py`](../../isaac/rl/stairs/__init__.py) | Marks the stair experiment as a separate Python source package |
| [`quadruped_stairs_v1.yaml`](../../isaac/rl/stairs/quadruped_stairs_v1.yaml) | Versioned task, staircase, curriculum, reward, termination, action, reset, and PPO values |
| [`create_stairs_world.py`](../../isaac/rl/stairs/create_stairs_world.py) | Composes collision stair layers over the validated flat Isaac world and writes a static-stage report |
| [`_stair_geometry.py`](../../isaac/rl/stairs/_stair_geometry.py) | Pure geometry definitions used by the generator and tests |
| [`_stair_rl_contract.py`](../../isaac/rl/stairs/_stair_rl_contract.py) | Pure observation, curriculum, height-query, reward, and failure functions |
| [`_quadruped_stairs_env.py`](../../isaac/rl/stairs/_quadruped_stairs_env.py) | Gymnasium/Isaac environment and episode metrics |
| [`_policy_transfer.py`](../../isaac/rl/stairs/_policy_transfer.py) | Controlled 48-input to 57-input policy initialization |
| [`_run_support.py`](../../isaac/rl/stairs/_run_support.py) | Schema-2 dependency, environment, PPO algorithm, transfer, and resume manifests |
| [`train_stairs_ppo.py`](../../isaac/rl/stairs/train_stairs_ppo.py) | PPO creation/resume, curriculum callback, checkpoints, TensorBoard, and training report |
| [`evaluate_stairs_ppo.py`](../../isaac/rl/stairs/evaluate_stairs_ppo.py) | Deterministic multi-episode evaluation and optional screenshot |
| [`record_stairs_ppo.py`](../../isaac/rl/stairs/record_stairs_ppo.py) | Deterministic external/onboard H.264 recording |
