...
| `simulation/scripts/setup_isaac_rl.ps1` | Tested Isaac Python dependency installation |
| `simulation/exports/isaac/quadruped_robot_manual_world.usda` | Validated gravity, contact, servo, camera, and IMU world |
