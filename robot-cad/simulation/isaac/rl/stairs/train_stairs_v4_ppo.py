"""Train the transfer-safe hardware-informed v4 stair PPO experiment."""
...
DEFAULT_CONFIG = SCRIPT_DIR / "quadruped_stairs_v4.yaml"
DEFAULT_OUTPUT = (
    PROJECT_ROOT / "simulation" / "isaac" / "output" / "rl" / "ppo-stairs-v4"
)
