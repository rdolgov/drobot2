...
| Simplified `190 mm` single-foot-lift PPO skill | [`rl-foot-lift-v1/README.md`](rl-foot-lift-v1/README.md) | Foot-lift IK reference, PPO balance residual, observation/reward/gates, hardware effort profile, training/evaluation, model, recording, or hosted review changes |
