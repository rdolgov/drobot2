...
| Pure parallel stair PPO (`180 mm` rise, `250 mm` tread) | [`rl-stairs-pure-parallel/README.md`](rl-stairs-pure-parallel/README.md) | Vectorized Isaac Lab environment, deployable observation contract, unphased reward, PPO training, checkpoint, evaluation, or recording changes |
| Force-verified per-leg fixed-tread placement and ordered-leg follow-up (`180 mm` rise, `250 mm` tread) | [`rl-stairs-v8-placement/README.md`](rl-stairs-v8-placement/README.md) | V8/v10 front-leg placement phases, force/contact/per-leg-slip gates, small PPO models/evaluations/recordings, v9 incenter body transfer, per-leg policy composition, or traction sensitivity |
...
| ST3215 one-leg testbed, four tracked leg profiles, and complete-bus commissioning apps | [`../hardware/one-leg-testbed/README.md`](../hardware/one-leg-testbed/README.md), [`../hardware/one-leg-testbed/config/README.md`](../hardware/one-leg-testbed/config/README.md), and [`../hardware/test-apps/README.md`](../hardware/test-apps/README.md) | USB setup, motor ID assignment, tracked leg mapping, one- or four-leg position control, neutral calibration, deterministic crawl choreography, helper scripts, telemetry monitoring, or hardware-test safety changes |
