...
| ST3215 one-leg testbed and four tracked leg profiles | [`../hardware/one-leg-testbed/README.md`](../hardware/one-leg-testbed/README.md) and [`../hardware/one-leg-testbed/config/README.md`](../hardware/one-leg-testbed/config/README.md) | USB setup, motor ID assignment, tracked leg mapping, position control, neutral calibration, helper scripts, telemetry, or hardware-test safety changes |
