...
```powershell
git switch develop
git apply --check <path-to-robot-cad>/tools/cad-viewer-markup/0001-Add-orthographic-CAD-markup-workspace.patch
git apply <path-to-robot-cad>/tools/cad-viewer-markup/0001-Add-orthographic-CAD-markup-workspace.patch
