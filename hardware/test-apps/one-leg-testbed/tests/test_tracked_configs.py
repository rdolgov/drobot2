...
CONFIG_DIR = Path(__file__).parents[3] / "robot-runtime" / "servos"
EXPECTED = {
    1: ((1, 2, 3), (-1, 1, 1), (2131, 2183, 1005)),
    2: ((4, 5, 6), (1, 1, 1), (2022, 2162, 2052)),
    3: ((7, 8, 9), (-1, -1, -1), (2020, 2052, 2046)),
    4: ((10, 11, 12), (1, 1, 1), (1998, 2049, 2048)),
}
